...
module.exports = {
  ...
  END_CHAR: "\u0004" # end of input char, maybe helpful to use switch statement

  NEW_LINE_CHAR: "\n" # do not use this in real code, put it here to make things clear

  SPACE: ' ' # do not use this in real code, put it here to make things clear
}